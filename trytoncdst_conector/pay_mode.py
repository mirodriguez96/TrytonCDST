        ...
        for fp in formas_pago:
            try:
                ...
                if paymode:
                    ...
                    if (paymode.name != nombre
                            or old_account != paymode.account):
                        paymode.name = nombre
                        paymode.save()
                        logs[id_tecno] = "FORMA DE PAGO ACTUALIZADA"
                else:
                    ...
                    sequence_multipayment = cls.find_seq(
                        'Voucher Multipayment')
