    ...
    def _get_payments(self, line_payments):
        ...
        for line in line_payments:
            ...
            if concept == 'Basico':
                ...
                if 'Transporte' not in list(subelements.keys()):
                ...
                if 'LHorasExtras' not in list(subelements.keys()):
                ...
                if 'LVacaciones' not in list(subelements.keys()):
                ...
                if 'Primas' not in list(subelements.keys()):
                    subelements['Primas'] = {}
                if concept == 'PrimasS':
                ...
                if 'Cesantias' not in list(subelements.keys()):
                ...
                if 'LIncapacidades' not in list(subelements.keys()):
                ...
                if 'LLicencias' not in list(subelements.keys()):
                ...
                if 'LBonificaciones' not in list(subelements.keys()):
                ...
                if 'LAuxilios' not in list(subelements.keys()):
                ...
                if 'LHuelgasLegales' not in list(subelements.keys()):
                ...
                if 'LOtrosConceptos' not in list(subelements.keys()):
                ...
                if 'LCompensaciones' not in list(subelements.keys()):
                ...
                if 'LBonoEPCTVs' not in list(subelements.keys()):
    ...
    def _get_deductions(self, line_deductions):
        ...
        for line in line_deductions:
            ...
            if concept == 'Salud':
                ...
                if 'FondoSP' not in list(subelements.keys()):
                    subelements['FondoSP'] = {}
                p = line.wage_type.unit_price_formula.split('*')
                p = Decimal(p[1].strip()) * 100
                valor = rvalue(line.amount, 2)
                ...
                if 'LSindicatos' not in list(subelements.keys()):
                ...
                if 'LSanciones' not in list(subelements.keys()):
                ...
                if 'LLibranzas' not in list(subelements.keys()):
                ...
                if 'LOtrasDeducciones' not in list(subelements.keys()):
